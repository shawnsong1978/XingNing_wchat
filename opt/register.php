...
<body>
<table width="100%"  height="440" cellpadding="0" cellspacing="1">
  <tr bgcolor="#FFFFFF">
    <td colspan="2" align="center" valign="middle">
    <table width="95%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>姓名：</td>
        <td align="right" valign="middle"><input name="name" type="text" id="name" style="background:#FFFFFF;color:#999; font-size:16px; text-align:right" size="15" value="abc" /></td>
      </tr>
    </table></td>
  </tr>
  <tr  bgcolor="#FFFFFF">
   ...
   <table width="95%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>电话：</td>
        <td align="right" valign="middle"><input name="tel" type="text" id="tel" style="background:#FFFFFF;color:#999; font-size:16px; text-align:right" size="15" value="abc" /></td>
      </tr>
    </table></td>
  </tr>
  <tr  bgcolor="#FFFFFF">
  ...
  <td colspan="2" align="center" valign="middle">
   <table width="95%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>性别：</td>
        <td align="right" valign="middle"><input name="radio" type="radio" id="Famale" value="Famale" checked="checked"  />
  ...
  <td colspan="2" align="center" valign="middle">
   <table width="95%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>所在位置：</td>
        <td align="right" valign="middle"><select  id="province" name="province" onchange="selectcity()"  style="font-size:16px;width:70px; border:1px solid #C0C0C0" /></select> 
        <select id="city" name="city" style="font-size:16px;width:75px;border:1px solid #C0C0C0" /></select></td>
      </tr>
    </table></td>
  ...
  <td colspan="2" align="center" valign="middle">
    <table width="95%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>紧急联系人：</td>
        <td align="right" valign="middle"><input name="em_name" type="text" id="em_name" style="background:#FFFFFF;color:#999; font-size:16px; text-align:right" size="15" value="abc" /></td>
      </tr>
    </table></td>
  </tr>
  <tr  bgcolor="#FFFFFF">
   <td colspan="2" align="center" valign="middle">
    <table width="95%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td>紧急联系人电话：</td>
        <td align="right" valign="middle"><input name="em_tel" type="text" id="em_tel" style="background:#FFFFFF;color:#999; font-size:16px; text-align:right" size="15" value="abc" /></td>
      </tr>
    </table></td>
  </tr>
  <tr  bgcolor="#CCCCCC">
